...
Python • PyTorch • Transformers • Large Language Models (LLMs) • Retrieval-Augmented Generation (RAG) • Bioinformatics • Gene Ontology • UniProt • Ensembl • PubMed • ClinVar • STRING • Machine Learning • Deep Learning • Data Science

GENEXIS represents the intersection of Artificial Intelligence, Data Science, and Computational Biology, demonstrating how modern transformer architectures and LLMs can accelerate biomedical discovery and support the future of precision medicine. Having this work published in IEEE and indexed in Scopus is an important milestone in my journey as an aspiring Data Scientist and AI Engineer, reinforcing my passion for building intelligent systems that create real-world impact.
